...
routerImage.src = "projects/zigbee/img/router.png";

var endDeviceImage = new Image();
endDeviceImage.src = "projects/zigbee/img/endDevice.png";
...
function redrawAvatar(mouseEvent) {
	...
	coordinatorImage.src = "projects/zigbee/img/coordinator.png";
